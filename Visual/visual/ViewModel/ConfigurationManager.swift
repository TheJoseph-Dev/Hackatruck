...
struct UserConfig: Identifiable {
    ...
    static let let voiceOptions = ["Masculina", "Feminina", "Taylor Swift"]
    static let languageOptions = ["pt-br", "en-us", "es", "zn"]
...
class ConfigurationManager: ObservableObject {
    ...
    func updateProfile() async {
        ...
        var encodeConfig = currentConfig.toDecodeConfig()
        print(encodeConfig._id)
        print(encodeConfig._rev)
        encodeConfig.nome = "Felipe"
        do {
